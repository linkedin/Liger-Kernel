...
def lce_forward(
    ...
    **kwargs,
    ...
    r"""
    Copy paste Ministral's forward but replace torch cross entropy with liger fused linear cross entropy
    ...
    >>> model = MinistralForCausalLM.from_pretrained("mistralai/Ministral-8B-Instruct-2410")
