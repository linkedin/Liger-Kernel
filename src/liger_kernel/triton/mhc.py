...
def _require_triton() -> None:  # pragma: no cover
    if triton is None or tl is None:
        raise RuntimeError(
            "Triton is required for liger_kernel.triton.mhc, but it could not be imported. "
            "Install triton and ensure you are running on a CUDA-capable environment."
        )
