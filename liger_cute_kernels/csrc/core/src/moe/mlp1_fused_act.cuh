...
// ═══════════════════════════════════════════════════════════════════
// Cooperative 2-WG Consumer — dual-acc, silu coefs + Z
// ═══════════════════════════════════════════════════════════════════
//
// z_m is the M-tile index into the output buffers. Split axis selected
// by TileM (kMSplit pattern):
