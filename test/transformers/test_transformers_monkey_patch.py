...
def test_apply_liger_kernel_no_supported_model_type():
    ...
    with patch.dict(MODEL_TYPE_TO_APPLY_LIGER_FN, {
...
def test_apply_liger_kernel_passes_kwargs():
    ...
    with patch.dict(MODEL_TYPE_TO_APPLY_LIGER_FN, {
        ...
        apply_liger_kernel("llama", rope=False, cross_entropy=True, fused_linear_cross_entropy=False),
        mock_llama.assert_called_once_with(rope=False, cross_entropy=True, fused_linear_cross_entropy=False)