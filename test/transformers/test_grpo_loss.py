...
def test_grpo_loss_with_vllm_is_ratio(B, T, V, beta, loss_type, importance_sampling_level):
    """Test that triton_grpo_loss with vllm_is_ratio matches TRL's behavior."""
    torch.manual_seed(42)
